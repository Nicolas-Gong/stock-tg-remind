...
已集成腾讯财经JSON API (`https://sqt.gtimg.cn/?q=sh000001&fmt=json`)，自动解析实时股票数据。
...
腾讯财经JSON API返回标准JSON格式，每个股票代码作为key，对应值为数据数组：

```json
{
  "sh000001": ["1", "上证指数", "000001", "3874.56", "3875.79", "3873.12", "142078476", ...],
  "sz399001": ["51", "深证成指", "399001", "13027.46", "13006.72", "13020.29", "211860941", ...]
}
```
